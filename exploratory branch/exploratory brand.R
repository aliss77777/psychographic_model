...
FA_dataset <- mydata[complete.cases(mydata),-c(1,67:69)] # removing extraneous columns
...
semPaths(poly_fit, what = "est", residuals = FALSE,
...
data.for.model <- mydata_withFA[,c(69:79)]
